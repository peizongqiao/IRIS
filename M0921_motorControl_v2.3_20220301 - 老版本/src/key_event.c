...
void add_key_event(void)
{
	...
	key_add(get_k8_press, motorRunFont21, eWobble, NULL);		//正转21步
	key_add(get_k9_press, motorRunFont30, eWobble, NULL);		//反转30步
	key_add(get_k10_press, motorRunFont16, eWobble, NULL);			//循环老化

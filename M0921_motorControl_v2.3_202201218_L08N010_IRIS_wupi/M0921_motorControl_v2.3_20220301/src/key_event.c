...
{
	key_add(get_k2_press, motorRunFont19, eWobble, NULL);			//正转19步
	key_add(get_k4_press, motorRunBack19, eWobble, NULL);			//反转19步
	
	key_add(get_k3_press, motorAging, eWobble, NULL);		//顺19，逆19，循环
	key_add(get_k7_press, motorRunFont17, eWobble, NULL);		//正转19步，逆时针21	
	key_add(get_k10_press, motorRunBack17, eWobble, NULL);		//顺19，逆21，循环
	
	
	key_add(get_k5_press, motorRunBack1, eWobble, NULL);		//反转1步
	key_add(get_k6_press, motorRunFont1, eWobble, NULL);		//正转1步
	
	key_add(get_k8_press, motorRunFont15, eWobble, NULL);		//顺10拍，反21

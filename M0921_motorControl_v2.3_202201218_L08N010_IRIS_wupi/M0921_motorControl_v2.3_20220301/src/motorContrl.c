...
uint8_t agingMode_1 = false;
uint8_t agingMode_2 = false;
uint8_t agingMode_3 = 0;
uint8_t agingMode_4 = 0;
...
void motorRunFont17()
{
	//motorSteps2Run = 10+128;
	if(agingMode_2 == false)
	{
		agingMode_2 = true;
	}
}

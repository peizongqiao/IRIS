...
{
	key_add(get_k2_press, run_ccw_end, eWobble, NULL);		//反转41步
	key_add(get_k3_press, motorRunFont41, eWobble, NULL);		//正转41步

	key_add(get_k5_press, motorRunBack17, eWobble, NULL);		//反转17步	
	key_add(get_k6_press, motorRunFont17, eWobble, NULL);		//正转17步
	key_add(get_k7_press, motorRunFont30, eWobble, NULL);		//正转30步
	
	key_add(get_k8_press, motorRunBack1, eWobble, NULL);		//反转1步
	key_add(get_k9_press, motorRunFont1, eWobble, NULL);		//正转1步	
		
	key_add(get_k10_press, motorAging, eWobble, NULL);			//循环老化	

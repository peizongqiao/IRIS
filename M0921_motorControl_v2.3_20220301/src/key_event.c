...
void add_key_event(void)
{
	...
	key_add(get_k2_press, motorRunFont16, eWobble, NULL);		//正转16步
	key_add(get_k3_press, motorRunFont23, eWobble, NULL);		//正转23步	
	key_add(get_k4_press, motorRunFont29, eWobble, NULL);		//正转29步	
	key_add(get_k5_press, motorRunFont1, eWobble, NULL);		//正转1步
	key_add(get_k6_press, motorRunBack1, eWobble, NULL);		//反转1步
	key_add(get_k7_press, run_ccw_end, eWobble, NULL);			//反转回PI
	key_add(get_k8_press, motorRunFont7, eWobble, NULL);		//正转7步
	key_add(get_k9_press, motorRunBack7, eWobble, NULL);		//反转7步

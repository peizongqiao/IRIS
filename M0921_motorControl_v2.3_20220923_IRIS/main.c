...
#define INTA2_H	PORTB_set_pin_level(3, 0)
#define INTA2_L	PORTB_set_pin_level(3, 1)

#define INTB2_H	PORTB_set_pin_level(4, 0)
#define INTB2_L	PORTB_set_pin_level(4, 1)

//drv8846 M0、M1控制，细分参数选择
#define M0_0	PORTB_set_pin_level(1, 0)
#define M0_1	PORTB_set_pin_level(1, 1)
#define M1_0	PORTC_set_pin_level(2, 0)
#define M1_1	PORTC_set_pin_level(2, 1)
...
//	OLED_Clear();
	...
	while (1) {
		...
		task_process();
		key_process();
		v = (float)ADC_0_get_conversion(7)*3.3/255;
